...
- **Source material:** Notion export (interview guide for practitioner/manager/front desk; three interviews at a multidisciplinary clinic — 20 employees, ~80 practitioners, kept anonymous on the site; research notes with personas, jobs, pains and proposed AI solution; competitor analysis of practice software (Jane, Carepatron, PowerDiary), AI scribes (Autonotes, Autoscribe/Mutuo Health, Nabla Copilot) and general transcription (Otter); the documented notes flow: consent, recording, clinician's own notes, transcript after the appointment, draft in the chosen template, clinician review and sign-off, patient-facing summary; "Video Call AI: demos" with scripted personas and three consultations for demo data; dashboards; proposal KPIs; design QA backlog).
