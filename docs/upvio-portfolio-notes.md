...
- **What existed vs. from zero (confirmed 2026-09-23):** Cogsworth already had scheduling (with many problems; clients constantly used workarounds to get where they wanted), custom forms (with problems), patient lists and settings (some very complex). Fernando redesigned the UX and UI of these; everything else was designed from zero.
